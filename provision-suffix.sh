...
function deploy() {
  oc adm $ARG_OC_OPS new-project dev-$PRJ_SUFFIX   --node-selector="env=citinova" --display-name="Tasks - Dev"
  oc adm $ARG_OC_OPS new-project stage-$PRJ_SUFFIX --node-selector="env=citinova" --display-name="Tasks - Stage"
  oc adm $ARG_OC_OPS new-project cicd-$PRJ_SUFFIX  --node-selector="env=citinova" --display-name="CI/CD"

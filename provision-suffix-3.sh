...
oc set resources dc/sonarqube --requests=cpu=4000m,memory=6Gi --limits=cpu=6,memory=6Gi -n $VAR_CICD_PROJECT
oc set probe dc/sonarqube --remove --readiness --liveness  -n $VAR_CICD_PROJECT
}

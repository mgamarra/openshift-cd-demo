...
VAR_CICD_PROJECT='citinova-devops-tools-2'
VAR_DEV_PROJECT='citinova-devops-app-dev-2' 
VAR_STAGE_PROJECT='citinova-devops-app-hom-2'
...
function deploy() {
  ...
  local template=https://raw.githubusercontent.com/$GITHUB_ACCOUNT/openshift-cd-demo/$GITHUB_REF/cicd-template-ephemeral.yaml
